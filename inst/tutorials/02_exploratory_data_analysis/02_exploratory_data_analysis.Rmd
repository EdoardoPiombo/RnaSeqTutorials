...
counts <- read.csv(here('inst/tutorials/02_exploratory_data_analysis/counts.csv'), row.names="X")
...
```{r dds, exercise=TRUE, exercise.eval=FALSE, exercise.setup="density"}
...
saveRDS(txi, file = here("inst/tutorials/02_exploratory_data_analysis/dds.rds"))
