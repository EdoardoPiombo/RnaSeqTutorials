...
if (!file.exists(here(metadata_file))) {
...
write.csv(as.data.frame(counts), file = counts_file)
...
quiz(caption="`tximport` object",
     question("What is it?",
              ...
              answer("a data.frame"),
              answer("an S4 object")),
     text_input("How many values are stored in it?"),
     text_input("How many samples and how many genes were reported?"),
