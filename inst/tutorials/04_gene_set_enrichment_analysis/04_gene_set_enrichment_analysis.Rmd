...
```{r comparison, exercise=TRUE, exercise.eval=FALSE, exercise.lines=10, exercise.setup="tests"}
...
```{r upset, exercise=TRUE, exercise.eval=FALSE, exercise.lines=12, exercise.setup="comparison"}
library(UpSetR)
...
```{r comp2, exercise=TRUE, exercise.eval=FALSE, exercise.lines=15, exercise.setup="tests"}
