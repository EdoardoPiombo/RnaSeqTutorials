...
You can also access ExploreModelMatrix with the following code in R:

```{r ExploreModelMatrix, echo=TRUE, eval=FALSE}
pacman::p_load("ExploreModelMatrix")
ExploreModelMatrix(sampleData = readr::read_tsv(
  here::here("RnaSeqTutorials/inst/tutorials/03_differential_gene_expression/www/samples_table.tsv")),
  designFormula = ~ time * treatment)
